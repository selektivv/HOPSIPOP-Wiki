...
Open it through `/shortcuts` or the Shortcuts button in `/mc`. It shows stored item types, total items, available [Capacity](../capacity.md), and links to unlocked features such as claims, perks, guides, shared networks, and the [Capacity](../capacity.md) World.
