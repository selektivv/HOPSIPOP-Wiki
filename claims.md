...
- [Capacity](capacity.md)-rank requirements.
- Mining-upgrade purchases.

Before expanding a claim, check `/perks` for rank progress and check Master Chest Shortcuts for stored items and free space.
...
The refunded [Capacity](capacity.md) immediately returns to the connected progression total and can increase free storage space or rank progress.
...
If spending crosses a rank requirement, the current [Capacity](capacity.md) rank and its benefits can be lost until the required total is restored.
...
2. Estimate whether the new area leaves enough [Capacity](capacity.md) for storage and rank requirements.
